...
{ 
 if (a >= 45) 
 {
 cout << "Array is full. Cannot insert at the end." << endl;  return; 
 } 
 int b, count = 0; 
...
int main() { 
 ...
 while (n >= 45 || n <= 0) 
 { 
 cout << "Invalid size. Enter a valid size" << endl;  cin >> n; 
 } 
 for (int i = 0; i < n; i++) 
 { 
 cout << "Enter detail: "; 
 ...
 cout << "Want to perform another operation? (y/n): ";  cin >> ans; 
 } 
 return 0; 
} 